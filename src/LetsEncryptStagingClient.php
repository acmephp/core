...
/**
 * Let's Encrypt implementation of the AcmeClient (staging version).
 *
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class LetsEncryptStagingClient extends AcmeClient
{
    const AUTHORITY = 'https://acme-staging.api.letsencrypt.org';
